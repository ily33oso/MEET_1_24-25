...
@Autonomous(name="AFirst", group="Auto")
public class AFirst extends LinearOpMode {
    ...
    static final double     P_DRIVE_GAIN           = -0.1;     // Larger is more responsive, but also less stable 0.03
